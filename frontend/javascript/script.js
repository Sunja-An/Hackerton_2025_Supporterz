...
let lectureList = [
  ...
  let userLectureList = [
    ...
    {"Lecture Name": '英語読解（２）ａ', "Schedule": '火2', "Instructor": '叶澤　恵'},
    {"Lecture Name": '仏語（中級）ａ', "Schedule": '水2', "Instructor": '福島　亮'},
    {"Lecture Name": '宗教学講義ｂ', "Schedule": '木2', "Instructor": '土居　由美'},
    {"Lecture Name": 'ＴＯＥＩＣ（特級）Ⅰｂ', "Schedule": '金2', "Instructor": '新井　学'},
    {"Lecture Name": 'データ分析Ⅰ', "Schedule": '月3', "Instructor": '木村　剛'},
    {"Lecture Name": '仏語（中級）ｂ', "Schedule": '水3', "Instructor": '江口　祥光'},
    {"Lecture Name": 'データ分析Ⅰ', "Schedule": '木3', "Instructor": '都留　信行'},
    {"Lecture Name": '英語読解（１）ａ', "Schedule": '金3', "Instructor": '牧野　美季'},
    {"Lecture Name": '心理学ａ', "Schedule": '木4', "Instructor": '新井　学'},
    {"Lecture Name": '英語読解（１）ａ', "Schedule": '金4', "Instructor": '笠原　一郎'},
    {"Lecture Name": 'データ解析入門Ⅰ', "Schedule": '月5', "Instructor": '塚田　憲史'},
    {"Lecture Name": '英語読解（再）', "Schedule": '火5', "Instructor": '一色　かほる'},
    {"Lecture Name": '英語補講Ⅳ', "Schedule": '金5', "Instructor": 'Ｌ．カーン'},
    {
      "Lecture Name": "宗教学講義ｂ",
      "Schedule": "木２",
      "Instructor": "土居　由美"
